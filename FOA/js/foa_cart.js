...
(() => {
    ...
    $('.subscription-foa-cart-del-btn').on('click', () => {
        ...
        const price = $('.list-pd-cart-card .list-pd-cart-card-price');
        ...
        price.removeClass('selectedMember');
    })
...
function inputCheckPurchaseCart(purchasefreeBar, purchaseRedeemBar, purchaseCart) {
    ...
    if (purchasefreeBarInput === '' && purchaseRedeemBarInput === '') {
        ...
        $('.foa-cart-summary-btn').attr('onClick', 'window.location.href="FOA_checkout_summary_has_register_mbo.html"');
    }
}
